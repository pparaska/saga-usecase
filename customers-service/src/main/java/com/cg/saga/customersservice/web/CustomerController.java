package com.cg.saga.customersservice.web;
...
import com.cg.saga.customerscommon.CreateCustomerResponse;
import com.cg.saga.customerscommon.GetCustomerResponse;
...
public class CustomerController {
	...
	public CreateCustomerResponse createCustomer(@RequestBody CreateCustomerRequest createCustomerRequest) {
		EntityWithIdAndVersion<Customer> ewidv = customerService.createCustomer(createCustomerRequest.getName(),
	...
	public ResponseEntity<GetCustomerResponse> GetCustomer(@PathVariable String customerId) {
		...
		GetCustomerResponse response = new GetCustomerResponse(
				customerWithMetadata.getEntityIdAndVersion().getEntityId(), customer.getCreditLimit(),
